...
public class SuspensionSportcar : MonoBehaviour {
    ...
    IEnumerator Upload(string jsonString) {
		...
		UnityWebRequest request = new UnityWebRequest("http://127.0.0.1:5000/api", "POST"); // "http://192.168.0.104:5000/api"
	...
	void Update() {
		...
		json["SpringFL"] = GameObject.Find("SpringFL").transform.localScale.z;
		json["SpringRR"] = GameObject.Find("SpringRR").transform.localScale.z;
		json["SpringRL"] = GameObject.Find("SpringRL").transform.localScale.z;
		json["WishboneTargetFR"] = GameObject.Find("WishboneTargetFR").transform.localPosition.z;
		json["WishboneTargetFL"] = GameObject.Find("WishboneTargetFL").transform.localPosition.z;
		json["WishboneRRTarget"] = GameObject.Find("WishboneRRTarget").transform.localPosition.z;
